...
export const Milwaukee: React.FC = () => {
  return (
    <CityPage
      ...
      description="Planning a trip to Milwaukee? Discover the top 15 things to do, from iconic landmarks to unique local experiences. Our complete 2025 guide covers where to stay, what to eat, and insider tips!"
      highlights={[
