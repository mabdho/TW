 ...
 * This script generates all pages using the Firebase HTML generation functions
 */
...
} from './server/html-generator';

import { generateSitemap, generateRobotsTxt } from './server/utils/standalone-seo';
