...
### Best Photo Spots
Capture stunning photos from the top of the tower, especially during sunset. Also, take some shots of the tower itself from Piazza di Porta Ravegnana for a good perspective.
...
### Best Photo Spots
Capture the grandeur of the Basilica di San Petronio, the Palazzo d'Accursio, and the Fountain of Neptune. The square is especially photogenic during golden hour.
...
### Best Photo Spots
Capture panoramic photos of Bologna from the sanctuary's terrace. The portico itself is also a great subject for photos, especially when viewed from a distance.
...
### What to Expect
Expect to be surrounded by the sights, sounds, and smells of delicious Italian cuisine. You'll find everything from fresh pasta and cured meats to local cheeses and pastries. It's a great place to sample regional specialties and soak up the atmosphere. Be prepared for crowds, especially during lunchtime and weekends. Many shops offer free samples, so don't be shy about trying new things.
...
### What to Expect
Expect a bustling, informal atmosphere with communal tables and friendly service. The menu features classic Bolognese dishes like tagliatelle al ragù, tortellini in brodo, and crescentine. Portions are generous and prices are reasonable. This isn't a fancy restaurant, but it's a great place to experience authentic Bolognese food.
...
Bologna is a relatively compact city, and most of the main attractions are located within walking distance of each other. Walking is definitely the best way to explore the historic center and soak up the atmosphere. However, for longer distances or if you're tired of walking, there are several other transportation options available.

### Public Transport
Bologna has a good public transport system, including buses and trams. Tickets can be purchased at tabaccherias (tobacconists) or at vending machines. Consider purchasing a day pass if you plan to use public transport frequently. Citymapper app will help you plan journeys.

### Taxis & Rideshare
Taxis are available throughout the city, but they can be expensive. Rideshare services like Uber are also available, but they may be limited. It's usually best to book a taxi in advance, especially during peak hours.`,
        whereToStay: `## Where to Stay in Bologna

Bologna offers a variety of accommodation options, from budget-friendly hostels to luxury hotels. The best area to stay depends on your preferences and budget. For proximity to main attractions, stay near Piazza Maggiore.

### Best Areas
The historic center is the most convenient area to stay, as it's close to all the main attractions. However, it can be more expensive. The university area is a good option for budget-conscious travelers, as it has a vibrant atmosphere and is well-connected by public transport.

### Luxury Options
For a luxurious stay, consider hotels like the Grand Hotel Majestic gia' Baglioni or the Hotel Corona d'Oro.`,
        bestTimeToVisit: `## Best Time to Visit Bologna

The best time to visit Bologna is during the spring or fall, when the weather is mild and the crowds are smaller. Summer can be hot and crowded, while winter can be cold and rainy. However, each season has its own unique charm.

### Peak Season
The peak season in Bologna is during the summer months (June-August), when the weather is warm and sunny. However, this is also the most crowded and expensive time to visit.

### Weather Overview
Spring (April-May) and Fall (September-October) offer pleasant temperatures and fewer crowds. Winter (November-March) can be cold and rainy, but it's a good time to visit if you're looking for a more budget-friendly trip. Summers (June-August) are hot and humid with average temperatures in the high 20s Celsius (mid-80s Fahrenheit).`,
        suggestedItinerary: `## Suggested Bologna Itinerary

Here's a suggested itinerary for a 3-day trip to Bologna. This itinerary balances must-see attractions with local experiences.

### Day 1
Start your day with a visit to Piazza Maggiore and the Basilica di San Petronio. Climb the Asinelli Tower for panoramic views. In the afternoon, explore the Quadrilatero market district and indulge in a delicious lunch at Osteria dell'Orsa. Finish the day with a relaxing stroll through the city center.

### Day 2
Visit the Sanctuary of San Luca and enjoy the stunning views. In the afternoon, explore the University of Bologna and its historic buildings. Visit the Finestrella to see Bologna's hidden canals. Enjoy dinner at a traditional trattoria.

### Day 3
Take a day trip to nearby Parma or Modena, known for their culinary specialties. Alternatively, explore more of Bologna's hidden gems, such as the Santo Stefano complex or the Pinacoteca Nazionale di Bologna.`
      }}
      faqs={[
        {
      ...
      discoveryData={{
        ...
        budgetBreakdown: {
          freeActivities: "Visiting Piazza Maggiore,Walking the porticoes,Exploring the University of Bologna courtyards,Finding the Finestrella",
          budgetFriendly: "Climbing the Asinelli Tower (€5),Lunch at Osteria dell'Orsa (€10-€15),Bus day pass (€5),Gelato (€3-€5)",
          splurgeWorthy: "Cooking class (€100),Fine dining experience (€50-€100 per person)"
        },
        localSecrets: ["To avoid crowds at the Asinelli Tower, visit on Tuesdays at 8:30 AM. Enter through the main entrance but head directly to the ticket counter before the tour groups arrive. You'll have the tower almost to yourself.", "For public transport, buy the 'City Red Bus' travel card for unlimited rides in Bologna. Download the TPER app for real-time bus schedules and platform information. Remember to validate your ticket at the machine upon boarding – it's a local transit etiquette rule.", "A realistic budget for 3 days in Bologna is €45-60 per day. This covers budget meals (€10-15 per meal), a transportation day pass (€5), and entrance fees to a few attractions (€5-10). Budget extra for souvenirs and spontaneous gelato stops.", "For authentic goods, visit the Mercato di Mezzo in the Quadrilatero district. This indoor market offers local cheeses, meats, and produce. Haggling isn't common, but you can sometimes negotiate a small discount for larger purchases if you speak Italian.", "Avoid the restaurants directly on Piazza Maggiore that feature English menus and tout "traditional" dishes. They are usually overpriced and cater to tourists. Instead, venture a few blocks off the square to Trattoria Anna Maria (Via delle Belle Arti, 17/A) for a truly authentic Bolognese meal at a fraction of the price.", "During the last week of June, Bologna hosts 'Biografilm Festival,' an international film festival. This can impact transportation and accommodation, so book in advance if planning to attend. On the other hand, be aware that many small businesses close for 'Ferragosto' in mid-August, so check opening hours beforehand."],
        diningHighlights: {
          mustTryDishes: "Tagliatelle al ragù (Bolognese sauce),Tortellini in brodo (broth),Mortadella,Crescentine",
          bestCafes: "Caffè Terzi: Known for its high-quality coffee and elegant atmosphere.,Pasticceria Gamberini: A historic pastry shop with a wide selection of cakes and pastries.",
          topRestaurants: "Osteria dell'Orsa: A local favorite for traditional Bolognese cuisine.,Trattoria Anna Maria: A hidden gem serving authentic Bolognese dishes.",
          foodMarkets: "Quadrilatero: A historic market district with food stalls and artisan shops.,Mercato di Mezzo: An indoor market offering local cheeses, meats, and produce.",
          diningTips: "Tipping is not expected in Bologna, but it's customary to round up the bill.,Reservations are recommended at popular restaurants, especially on weekends.,Many restaurants offer a 'coperto' (cover charge), which is a small fee per person to cover the cost of bread and table service.,Lunch is typically eaten between 1:00 PM and 3:00 PM, and dinner is eaten between 8:00 PM and 10:00 PM."
        },
        seasonalHighlights: {
          spring: "Mild weather, blooming flowers, and outdoor festivals.",
          summer: "Warm and sunny weather, perfect for outdoor dining and exploring the city's parks.",
          fall: "Pleasant temperatures, harvest festivals, and beautiful autumn foliage.",
          winter: "Cold and rainy weather, Christmas markets, and cozy indoor activities."
        },
        quickFacts: {
          totalAttractions: "8",
          freeActivities: "4",
