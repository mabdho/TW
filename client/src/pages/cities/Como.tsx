...
export const Como: React.FC = () => {
  return (
    <CityPage
      cityName="Como"
      country="Italy"
      title={"Things to Do in Como, Italy (2025 Guide)"}
      description={`Discover things to do in Como — top attractions, hidden gems, and food spots. Complete Como travel guide.`}
