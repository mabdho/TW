...
export const Maracaibo: React.FC = () => {
  return (
    <CityPage
      title="15 Best Things to Do in Maracaibo, Venezuela (2025 Guide)"
      description="Planning a trip to Maracaibo? Discover the top 15 things to do, from iconic landmarks to unique local experiences. Our complete 2025 guide covers where to stay, what to eat, and insider tips!"
      highlights={[
