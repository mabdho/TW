...
export const Tokyo: React.FC = () => {
  return (
    <CityPage
      ...
      description={`Planning a trip to Tokyo? You're in for a treat! Discovering the best things to do in Tokyo can be a bit overwhelming, given the city's sheer size and`}
