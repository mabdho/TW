...
export const Venice: React.FC = () => {
  return (
    <CityPage
      cityName="Venice"
      country="Italy"
      title={"Things to Do in Venice, Italy (2025 Guide)"}
      description={`Discover things to do in Venice — top attractions, hidden gems, and food spots. Complete Venice travel guide.`}
