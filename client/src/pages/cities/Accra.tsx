...
export const Accra: React.FC = () => {
  return (
    <CityPage
      ...
      imageUrl={"https://images.unsplash.com/photo-1589104602532-9cee07f8f62c?q=80&w=1328&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
      galleryImages={[
      ]}
      highlights={["Visit the Kwame Nkrumah Mausoleum",
        "Explore the Jamestown neighborhood",
        "Relax on Labadi Beach",
        "Experience the Makola Market",
...
Tip: Visit during the weekdays to avoid larger crowds. The best time is before noon. Don't miss the statue of Nkrumah outside the mausoleum; it's quite impressive.`,
        ...
        cost: "Entrance fee is approximately GH₵ 20 for non-residents.",
        website: "ghanacms.gov.gh"
      },
      discoveryTags: {
        ...
        photoOpportunity: "Exterior shots of the mausoleum, especially early morning.",
        insiderTip: "Visit on a weekday morning before 11 AM to avoid school groups and large crowds.",
        hiddenGem: false,
        familyFriendly: true,
...
Tip: Hire a local guide to navigate the neighborhood and learn about its history. They can lead you to hidden gems and introduce you to the community.`,
        ...
        openingHours: "Open to explore anytime, but daytime is recommended.",
        cost: "Free to explore, but hiring a guide will cost approximately GH₵ 50-100.",
        website: ""
      },
      discoveryTags: {
        ...
        costLevel: "Budget-friendly",
        seasonalBest: "Year-round",
        photoOpportunity: "Panoramic city views from the lighthouse, colorful fishing boats.",
        insiderTip: "Visit on a weekday morning to see the fishermen bringing in their catch.",
        hiddenGem: false,
        familyFriendly: true,
        accessibilityNotes: "Some areas may not be wheelchair accessible due to uneven terrain."
      }
      },
        {
        name: "Labadi Beach",
...
Tip: Weekends are the busiest. For a quieter experience, visit during the weekdays. Negotiate the entrance fee before entering.`,
        ...
        openingHours: "Open daily, but typically most active during daylight hours.",
        cost: "Entrance fee is approximately GH₵ 10-20.",
        website: ""
      },
      discoveryTags: {
        timeRequired: "Half day",
        experienceLevel: "Easy Access",
        interests: ["relaxation", "beach", "nature"],
        costLevel: "Budget-friendly",
        seasonalBest: "Year-round",
        photoOpportunity: "Sunset views, beach activities, colorful umbrellas.",
        insiderTip: "Visit during the week to avoid the weekend crowds and higher entrance fees.",
        hiddenGem: false,
        familyFriendly: true,
        accessibilityNotes: "Sand can be difficult to navigate for those with mobility issues."
      }
      },
        {
        name: "Makola Market",
...
Tip: Keep your belongings secure and be aware of your surroundings. Bargaining is expected, so don't be afraid to negotiate the price.`,
        ...
        openingHours: "Open daily, typically from early morning until late afternoon.",
        cost: "Free to enter, but bring money for purchases.",
        website: ""
      },
      discoveryTags: {
        ...
        costLevel: "Budget-friendly",
        seasonalBest: "Year-round",
        photoOpportunity: "Vibrant market scenes, colorful textiles, local vendors.",
        insiderTip: "Visit with a local guide who knows the market layout and can help with bargaining.",
        hiddenGem: false,
        familyFriendly: true,
        accessibilityNotes: "Not wheelchair accessible due to crowded conditions."
      }
      },
        {
...
Tip: Allocate at least 2-3 hours to fully explore the museum's exhibits. The air conditioning can be a welcome relief from the Accra heat.`,
        ...
        openingHours: "Open Tuesday to Saturday from 9:00 AM to 5:00 PM.",
        cost: "Entrance fee is approximately GH₵ 15 for non-residents.",
        website: "museums.ghana.net"
      },
      discoveryTags: {
        timeRequired: "2-3 hours",
        experienceLevel: "Easy Access",
        ...
        costLevel: "Budget-friendly",
        seasonalBest: "Year-round",
        photoOpportunity: "Traditional artifacts, Asante stools, historical exhibits.",
        insiderTip: "Hire a museum guide for a more in-depth understanding of the exhibits.",
        hiddenGem: false,
        familyFriendly: true,
        accessibilityNotes: "Wheelchair accessible."
      }
...
Reservations are recommended, especially for dinner. Be sure to try the local juices like bissap (hibiscus) or ginger drink.`,
        ...
        openingHours: "Open daily from 12:00 PM to 10:00 PM.",
        cost: "Moderate (GH₵ 50-150 per person).",
        website: ""
      },
      discoveryTags: {
        timeRequired: "1-2 hours",
        ...
        costLevel: "Moderate",
        seasonalBest: "Year-round",
        photoOpportunity: "Colorful food plating, vibrant restaurant interior.",
        insiderTip: "Make reservations for dinner, especially on weekends.",
        hiddenGem: false,
        familyFriendly: true,
...
Visit during happy hour for discounted drinks. The rooftop terrace offers great views of the city.`,
        ...
        openingHours: "Open daily from 5:00 PM to late.",
        cost: "Moderate to Expensive (GH₵ 75-200 per person).",
        website: ""
      },
      discoveryTags: {
        timeRequired: "2-3 hours",
        ...
        costLevel: "Moderate",
        seasonalBest: "Year-round",
        photoOpportunity: "Rooftop city views, creative cocktails, vibrant atmosphere.",
        insiderTip: "Arrive early to secure a spot on the rooftop terrace.",
        hiddenGem: false,
        familyFriendly: true,
        accessibilityNotes: "May not be fully accessible due to stairs."
      }
      },
        {
...
Consider making a reservation for Sunday brunch. Dress code is smart casual.`,
        ...
        openingHours: "Open daily for breakfast, lunch, and dinner. Breakfast buffet: 6:30 AM - 10:30 AM",
        cost: "Expensive (GH₵ 200+ per person).",
        website: "movenpick.accra-hotels.com"
      },
      discoveryTags: {
        timeRequired: "2-3 hours",
        experienceLevel: "Easy Access",
        interests: ["food", "dining", "luxury"],
        costLevel: "Expensive",
        seasonalBest: "Year-round",
        photoOpportunity: "Elegant restaurant decor, beautifully plated dishes.",
        insiderTip: "Make a reservation for the Sunday brunch.",
        hiddenGem: false,
        familyFriendly: true,
...
Check the schedule for upcoming events. The center is a quiet and peaceful place, ideal for reflection.`,
        ...
        openingHours: "Open Monday to Friday, 8:00 AM to 5:00 PM.",
        cost: "Entrance fee is approximately GH₵ 10.",
        website: "duboisghana.org"
      },
      discoveryTags: {
        timeRequired: "1-2 hours",
        experienceLevel: "Easy Access",
        interests: ["history", "culture", "activism"],
        costLevel: "Budget-friendly",
        seasonalBest: "Year-round",
        photoOpportunity: "Du Bois's mausoleum, library, and home.",
        insiderTip: "Visit during a lecture or workshop for a more enriching experience.",
        hiddenGem: false,
        familyFriendly: true,
        accessibilityNotes: "Generally accessible."
      }
...
Tip: Bargaining is possible, especially if you are buying multiple items. This place is a great spot to get gifts for loved ones back home.`,
        ...
        cost: "Free to enter, but prices vary depending on the items purchased.",
        website: ""
      },
      discoveryTags: {
        timeRequired: "1-2 hours",
        experienceLevel: "Easy Access",
        interests: ["culture", "shopping", "art"],
        costLevel: "Moderate",
        seasonalBest: "Year-round",
        photoOpportunity: "Colorful displays of handicrafts, intricate wood carvings, vibrant textiles.",
        insiderTip: "Visit during the weekdays to avoid larger crowds.",
        hiddenGem: false,
        familyFriendly: true,
        accessibilityNotes: "Wheelchair accessible."
      }
...
Arrive early (around 6:00 PM) to avoid the biggest crowds. Be prepared to bargain on prices.`,
        ...
        openingHours: "Open daily from approximately 6:00 PM to late.",
        cost: "Budget-friendly (GH₵ 20-50 per person).",
        website: ""
      },
      discoveryTags: {
        timeRequired: "1-2 hours",
        ...
        costLevel: "Budget-friendly",
        seasonalBest: "Year-round",
        photoOpportunity: "Street food vendors, vibrant market scenes, colorful dishes.",
        insiderTip: "Arrive before 7 PM to get fresh food and avoid long queues.",
        hiddenGem: false,
        familyFriendly: true,
        accessibilityNotes: "May not be fully accessible due to crowded conditions."
      }
      }
      ]}
      logistics={{
        gettingAround: `## Getting Around Accra
...
Visit the W.E.B. Du Bois Memorial Centre for Pan African Culture. In the afternoon, shop for souvenirs at Wild Gecko Handicrafts. In the evening, experience the Osu Night Market.`
      ...
      faqs={[
        {
        question: "What are the best things to do in Accra?",
        answer: `Some of the best things to do in Accra include visiting the Kwame Nkrumah Mausoleum, exploring Jamestown, relaxing on Labadi Beach, experiencing Makola Market, and learning at the National Museum of Ghana.`
      },
        {
        question: "How many days do you need in Accra?",
        answer: `3-4 days is a good amount of time to explore Accra's main attractions and get a feel for the city. You can adjust this based on your interests and pace.`
      },
        {
        question: "What is Accra famous for?",
        answer: `Accra is famous for its rich history, vibrant culture, bustling markets, and beautiful beaches. It's also known as a hub for Pan-Africanism.`
      },
        {
        question: "When is the best time to visit Accra?",
        answer: `The best time to visit Accra is during the dry season, from November to March, when the weather is warm and sunny.`
      }
      ]}
      discoveryData={{
        cityPersonality: "Vibrant, Historical, Energetic",
        budgetBreakdown: {
          freeActivities: "Exploring Jamestown,Visiting Independence Square,Walking along Labadi Beach,Wandering through the Arts Centre",
          budgetFriendly: "Entrance to Kwame Nkrumah Mausoleum (GH₵ 20),Entrance to National Museum of Ghana (GH₵ 15),Meal at a local chop bar (GH₵ 30-50),Tro tro ride (GH₵ 2-5)",
          splurgeWorthy: "Fine dining experience at Sankofa Restaurant (GH₵ 200+ per person),Luxury hotel stay at Mövenpick Ambassador Hotel (GH₵ 1000+ per night)"
        },
        localSecrets: ["Visit the Kwame Nkrumah Mausoleum on Tuesday mornings around 8:30 AM, just after opening. Enter through the back gate (ask the guards for directions) to avoid the tour groups that arrive later in the morning.", "To navigate Accra's tro tros like a local, download the 'GhanaMoves' app for route guidance (though it's not always accurate, it helps with general direction). Purchase a 'GoCard' at any major tro tro station to simplify payments. Remember to always announce your destination clearly to the mate (conductor).", "A realistic budget for 3 days in Accra is approximately GH₵ 450-600 (USD 40-55) per day. This includes GH₵ 100-150 for meals, GH₵ 50-75 for transportation, GH₵ 100-150 for attractions, and GH₵ 200-275 for miscellaneous expenses. Local beer is about GH₵10-15.", "For authentic Ghanaian goods, head to the Kantamanto Market (also known as 'Secondhand Clothes Market') near Agbogbloshie. It's best for vintage clothing, but you need to bargain hard—start by offering half the initial price and work your way up. Go with a local friend.", "Avoid the beachfront restaurants directly on Labadi Beach. They are overpriced and cater to tourists. Instead, walk a few blocks inland and find local 'chop bars' serving the same dishes at a fraction of the price. Look for 'Mama Put' establishments.", "Attend the Chale Wote Street Art Festival in August (dates vary). It transforms Jamestown into an open-air gallery with music, dance, and art installations. Book accommodations well in advance as the city gets very crowded."],
        diningHighlights: {
          mustTryDishes: "Jollof Rice (spicy rice dish),Banku with Tilapia (fermented corn and cassava dough with grilled fish),Fufu with Groundnut Soup (pounded yam or plantain with peanut soup),Kelewele (spicy fried plantains)",
          bestCafes: "Vida e Caffè (South African chain with reliable coffee and pastries, located in several malls),Second Cup (International coffee chain with comfortable seating, located in Airport Residential Area)",
          topRestaurants: "Buka Restaurant (Ghanaian and West African cuisine),Republic Bar & Grill (Grilled dishes and cocktails),Santoku (Upscale Japanese Dining)",
          foodMarkets: "Osu Night Market,Makola Market (for a wide variety of ingredients and street food)",
          diningTips: "Tipping is not always expected but appreciated for good service (around 10%).,It's common to eat with your right hand in Ghana.,Be sure to try the local drinks like bissap and ginger beer."
        },
        seasonalHighlights: {
          spring: "Accra sees moderate temperatures and humidity, making it suitable for outdoor exploration. It is a good time for cultural events before the hotter summer months.",
          summer: "Summer is hot and humid, but the occasional rain can offer some relief. Beach visits are popular, and you can enjoy the vibrant nightlife.",
          fall: "The heat starts to subside in the fall, making it a pleasant time to visit. This is a great time to explore the markets and cultural sites.",
          winter: "Winter brings warm and sunny weather with low humidity, making it the peak tourist season. Expect higher prices and more crowds."
        },
        quickFacts: {
          totalAttractions: "12",
          freeActivities: "4",
