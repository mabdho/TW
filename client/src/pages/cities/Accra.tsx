...
export const Accra: React.FC = () => {
  return (
    <CityPage
      cityName="Accra"
      country="Ghana"
      title={"Things to Do in Accra, Ghana (2025 Guide)"}
      description={`Discover things to do in Accra — top attractions, hidden gems, and food spots. Complete Accra travel guide.`}
