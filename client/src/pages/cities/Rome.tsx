...
export const Rome: React.FC = () => {
  return (
    <CityPage
      ...
      imageUrl={"https://images.unsplash.com/photo-1529154036614-a60975f5c760?q=80&w=1752&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
      galleryImages={[
      ]}
