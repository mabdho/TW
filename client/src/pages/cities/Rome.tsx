...
export const Rome: React.FC = () => {
  return (
    <CityPage
      cityName="Rome"
      country="Italy"
      title={"Things to Do in Rome, Italy (2025 Guide)"}
      description={`Discover things to do in Rome — top attractions, hidden gems, and food spots. Complete Rome travel guide.`}
      imageUrl={"https://images.unsplash.com/photo-1529154036614-a60975f5c760?w=500&auto=format&fit=crop&q=75&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
      galleryImages={[
      ]}
