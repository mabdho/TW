...
export const Rome: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      cityName="Rome"
      country="Italy"
      title={"Best Things to Do in Rome - TravelWanders"}
      description={`Discover the best things to do in Rome. Complete travel guide with attractions, activities, and insider tips for your perfect Rome adventure.`}
