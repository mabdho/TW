...
export const Oslo: React.FC = () => {
  return (
    <CityPage
      ...
      imageUrl={"https://images.unsplash.com/photo-1712009509758-dff926710413?w=800&auto=format&fit=crop&q=75&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
      galleryImages={[
      ]}
