...
export const Berlin: React.FC = () => {
  return (
    <CityPage
      ...
      imageUrl={"https://images.unsplash.com/photo-1599946347371-68eb71b16afc?w=800&auto=format&fit=crop&q=75&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YmVybGlufGVufDB8fDB8fHww"}
      galleryImages={[
      ]}
