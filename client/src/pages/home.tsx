...
export default function Home() {
  const seoData = {
    title: "TravelWanders - Discover Amazing Travel Destinations Worldwide",
    description: "Discover amazing travel destinations worldwide with TravelWanders. Get expert travel guides, insider tips, and curated recommendations for your next adventure.",
