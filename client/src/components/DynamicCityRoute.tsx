...
const cityMap = {
  ...
  'prague': createCityImport('Prague', '../pages/cities/Prague'),

  'florence': createCityImport('Florence', '../pages/cities/Florence'),

  'paris': createCityImport('Paris', '../pages/cities/Paris'),

  'addu': createCityImport('Addu', '../pages/cities/Addu'),
};
